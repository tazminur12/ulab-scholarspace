...
export default function DashboardLayout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Question Bank', href: '/question-bank', icon: 'fa-solid fa-box-archive' },
    ...
    { name: 'Study Groups', href: '/study-groups', icon: 'fa-solid fa-people-group' },
    { name: 'Discussions', href: '/discussions', icon: 'fa-solid fa-comments' },
    { name: 'Course Reviews', href: '/course-reviews', icon: 'fa-solid fa-star-half-stroke' },
    { name: 'AI Quiz Gen', href: '/ai-quiz', icon: 'fa-solid fa-brain' },
    { name: 'AI Doubt Solver', href: '/ai-doubt-solver', icon: 'fa-solid fa-graduation-cap text-[#fbbf24]' },
